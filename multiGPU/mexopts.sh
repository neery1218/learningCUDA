...
#----------------------------------------------------------------------------
            ...
            CLIBS="$RPATH $MLIBS -lm -lmwgpu /usr/local/cuda-6.0/lib64/libcudart.so"
...
#
            ...
            CXXLIBS="$RPATH $MLIBS -lm -lmwgpu /usr/local/cuda-6.0/lib64/libcudart.so /usr/local/cuda-6.0/lib64/libcufft.so"
